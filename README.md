...
These are images, and the meta-data that extracts data from images was chosen using this link: https://www.worldclim.org/data/worldclim21.html#google_vignette. Each of these (a)biotic factors were downloaded as a “zip” file containing 12 GeoTiff (.tif) files. The code to extract or crop the European portion or part can be found in the R code. 
